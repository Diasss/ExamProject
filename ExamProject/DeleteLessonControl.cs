...
{
    public partial class DeleteLessonControl : UserControl
    {
        public static ComboBox ComboBox;
        public DeleteLessonControl()
        {
            InitializeComponent();
        ...
        {
            box.Items.Clear();
            string cmdstr = "SELECT * FROM Subjects";
        ...
        {
            string cmdstr = "DELETE FROM Subjects WHERE name = '" + name + "'";
            using (SqlConnection conn = new SqlConnection(Code.ConnectionString.Connstr))
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand(cmdstr, conn);
